...
const Page = () => {
  ...
  const deleteDoctor = async (id) => {
    try {
      const res = await fetch(`http://localhost:5000/api/v1/doctor/delete`, {
        method: "DELETE", // Ensure it matches your API method
      ...
      // Remove the doctor from state without refetching
            ...
            <div className={styles.filterButtons}>
              ...
              <button
                onClick={() => {
                  ...
                  setQuery("");
                  setSearchValue("");
                  setFilteredDoctors(doctor_data);
                  // ✅ Reset radio buttons
                  document
